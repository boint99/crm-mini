...
import ViettelModel from "@/pages/Viettel/Action/ViettelModel";
import {
  createEmployee,
  deleteEmployee,
  getEmployees,
...
import { headerTableEmployeesViettel } from "@/utils/headerTable";

const viettelColumns = Object.entries(headerTableEmployeesViettel);
  ...
  const renderTableBody = () => {
    if (loading) {
      return (
        <tbody>
          <tr>
            <td colSpan={viettelColumns.length + 1}>
              <LoadingItem />
            </td>
          </tr>
        </tbody>
            ...
            <td colSpan={viettelColumns.length + 1}>
              <div className="flex h-40 flex-col items-center justify-center gap-2 text-gray-400">
                ...
                <p className="text-sm font-medium">
                  Không có dữ liệu nhân viên Viettel
                </p>
              </div>
            </td>
          </tr>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-semibold text-gray-900">
            Quản lý nhân viên Viettel
          </h2>
          <p className="mt-1 text-sm text-gray-500">
            Dữ liệu hiển thị tất cả nhân viên Viettel.
          </p>
        </div>
        <button
          type="button"
